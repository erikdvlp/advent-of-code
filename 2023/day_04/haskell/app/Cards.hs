...
-- Calculate points for a given card.
...
-- Get the number of matches in a given card.
...
-- Modify given copies by adding more copies between a given index range.
-- Only used for part 2 of the problem.
...
-- Calculate the number of copies of given cards.
-- Only used for part 2 of the problem.
